...
<img src="docs/src/GridFunctions_logo.svg" align="center" width="200" alt="GridFunctions.jl Logo">
...
The library heavily utilizes `StaticArrays.jl` and `Val` types to ensure that grid metadata (dimensions, topology) incurs zero runtime overhead and allows LLVM to heavily optimize inner loops.
